...
> With thanks to **Henri ([@l-henri](https://github.com/l-henri))**, collaborator on the Shhh project, whose 2026-04-13 Nethermind AuditAgent scan first surfaced the three structural findings (C-1 / H-1 / I-3) that triggered the V8 rewrite a week before Omar's deep review.
